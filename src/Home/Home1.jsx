    ...
    <div className="body"> 
      <div className="box1">
        <div className="about-us">
          <strong className="us">About Us</strong><br /><br /> Our team consist
          of three members. Each of them has a significant contribution
          to the project. In the below, each team member, his works
          is mentioned. <br /> <br />
          <h5>Ali Ahmadli</h5>
      ...
      <div className="box2">
        <div className="introduction">
          <strong className="welcome">Welcome to Moviefy!</strong><br/><br /> We designed the best 1000 movies
          for <strong>You</strong>. Just click to <strong>Movie</strong> at the top. You will find yourself among the movies. 
          Click and view each movie IMDB rating, overview, genre, and runtime of movie. 
        </div>
        <div className="about">
          <div className="steps">
            <p className="all-steps">
              Steps based on XP.
            </p>
            <ul>
              <li>Communication</li>
          ...
          <div className="youtube-link">
            ...
            <br /> <br />
            <iframe width="500" height="250" src="https://www.youtube.com/embed/7okHiY4oErk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <br /> <br />
            <a href=""><strong>Github Link</strong></a>
          </div>
        </div>
      </div>
